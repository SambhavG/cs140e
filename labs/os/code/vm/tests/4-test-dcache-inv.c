...
void notmain(void) {
  ...
  pmu_stmt_measure_set(miss, access, "first access: should see one miss",
                       dcache_miss, dcache_access, { *ptr; });
  ...
  pmu_stmt_measure_set(miss, cnt, "first access: should see one miss",
                       icache_miss, inst_cnt, { fp(1); });
  ...
  pmu_stmt_measure_set(miss, access, "dcache should be flushed: expect 1 miss",
                       dcache_miss, dcache_access, { *ptr; });
