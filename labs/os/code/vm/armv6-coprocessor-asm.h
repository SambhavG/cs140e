 ...
 *
 * where CRn is the system co-processor registered.   Unless otherwise
 * specified, CRm and opcode_2 SBZ (should be zero).  [You can see how this
 * plays out below]
 *
 */
