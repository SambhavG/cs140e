/*
 * engler, cs140e: simple tests to check that you are handling rising and
 * falling edge interrupts correctly.
 *
 * NOTE: make sure you connect your GPIO 20 to your GPIO 21 (i.e., have it
 * "loopback")
 */
#include "rpi.h"
// asdf
