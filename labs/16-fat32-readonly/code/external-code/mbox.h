...
static inline void mbox_write(unsigned channel, volatile void *data) {
...
static inline unsigned mbox_read(unsigned channel) {
  assert(channel == MBOX_CH);
...
static inline uint32_t mbox_send(unsigned channel, volatile void *data) {
