...
void domain_access_ctrl_set(uint32_t d) { staff_domain_access_ctrl_set(d); }
...
void pin_clear(unsigned idx) { staff_pin_clear(idx); }

void staff_lockdown_print_entry(unsigned idx);

void lockdown_print_entry(unsigned idx) { staff_lockdown_print_entry(idx); }
