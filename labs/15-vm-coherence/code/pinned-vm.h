...
enum { PAGE_4K = 0b01, PAGE_64K = 0b10, PAGE_1MB = 0b11, PAGE_16MB = 0b00 };
...
static inline pin_t pin_mk(uint32_t G, uint32_t dom, uint32_t asid,
                           mem_perm_t perm, mem_attr_t mem_attr) {
...
//  - non-cacheable
//  - default: 1mb section.
static inline pin_t pin_mk_global(uint32_t dom, mem_perm_t perm,
                                  mem_attr_t attr) {
  // G=1, asid=0.
...
static inline pin_t pin_mk_user(uint32_t dom, uint32_t asid, mem_perm_t perm,
                                mem_attr_t attr) {
